...
const Home = () => {
    ...
    return (
        <div className="flex flex-col items-center gap-10 pt-3 w-full">
            ...
            <Link to="/pokemon-list" className="text-lg border-2 border-black bg-amber-400 shadow-black shadow-md py-2 px-6 rounded-3xl hover:bg-amber-500">Get My Pokemon</Link>
