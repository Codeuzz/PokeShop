...
const Navbar = () => {
  ...
  return (
    <nav className="w-full p-5 border-b-4 border-black flex justify-between items-center">
      <Link to="/PokeShop/">
        <img src="./pokeball.png" className="w-10" />
      </Link>
      <ul className="flex justify-around text-xl items-start gap-32">
        <li>
        ...
        <li>
          <Link to="/PokeShop/articles">Articles</Link>
        </li>
      </ul>
      <Link
        to="/PokeShop/cart"
